  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row items-center py-[6px] px-4 rounded-[10px] mb-2 bg-slate-400 bg-discount-gradient">
        ...
        <p className={`${styles.paragraph} mt-5 max-w-[550px]`}>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel in nisi
          repellendus architecto enim optio nihil ullrelativeam suscipit.
          Labore, quod.
        </p>
